...
const App = () => {
    ...
    const handleGeneratePassword = () => {
        if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
            ...
            notify('Successfully generate password', false);
        }
    };
        ...
        <div className="App">
            <div className="container">
                <div className="generator">
                    <h2 className="generator__header">Password Generator V2</h2>
                    <div className="generator__password">
                        <h3>{password}</h3>
                        <button className="copy__btn">
                            <i onClick={copyPasswordHandler} className="far fa-clipboard"></i>
                        </button>
                    </div>
